...
class DropPath(nn.Module):
    ...
    def forward(self, x):
        return timm.layers.drop_path(x, self.drop_prob, self.training)
...
class HybridEmbed(nn.Module):
    ...
    def __init__(self, backbone, img_size=224, feature_size=None, in_chans=3, embed_dim=768):
        ...
        if feature_size is None:
            ...
            feature_size = timm.layers.to_2tuple(feature_size)
...
class ViT(nn.Module):
    ...
    def __init__(
        ...
        if self.pos_embed is not None:
            timm.layers.trunc_normal_(self.pos_embed, std=0.02)
